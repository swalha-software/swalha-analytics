...
export const metadata: Metadata = {
  title: {
    default: "SWALHA Analytics - Privacy-First Web Analytics Platform",
    template: "%s | SWALHA Analytics",
  },
  description:
  ...
  openGraph: {
    ...
    title: "SWALHA Analytics - Privacy-First Web Analytics Platform",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "SWALHA Analytics social card",
      },
    ],
  },
  twitter: {
